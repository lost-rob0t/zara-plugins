...
def _repository_payload(evidence: Mapping[str, object]) -> dict[str, object]:
    ...
    if (
        ...
        raise CodingError("repository evidence head must be a canonical lowercase full Git object ID")
...
def _worktree_payload(value: object) -> dict[str, object]:
    ...
    if (
        ...
        raise CodingError("repository evidence worktree head must be a canonical lowercase full Git object ID")
