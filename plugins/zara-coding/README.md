...
No arbitrary shell/eval, worktree mutation, branch overwrite/move, auto-staging, build execution, worker spawning, model-installed semantic provider, or model-driven success claim is exposed by the current surface.
