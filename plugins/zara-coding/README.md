...
- `coding.git.worktrees` returns up to 100 worktrees as structured path/HEAD/branch/detached/locked/prunable evidence using Git's porcelain `-z` format. It is read-only and never accepts caller-controlled Git arguments.
