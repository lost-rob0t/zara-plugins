...
class HostileEvidenceRef(str):
    def __new__(cls):
        return super().__new__(cls, "host-controlled-data-evidence")
...
def successful_predicate_result(data_evidence_ref):
    return SimpleNamespace(
        ...
        data={
            ...
            "evidence_refs": [data_evidence_ref],
        },
...
class LispDataEvidenceIdentityTests(unittest.TestCase):
    def test_hostile_data_evidence_string_subclass_fails_closed(self):
