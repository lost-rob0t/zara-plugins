...
class NixBashLateHostResultOwnershipTests(unittest.TestCase):
            ...
            with self.subTest(expert_id=module.EXPERT_ID):
                ...
                def validate_then_mutate_host(result, **kwargs):
                    ...
                    if calls == 2:
                        ...
                        runtime.host_result["data"]["result"]["kind"] = "late-host-rewrite"  # type: ignore[index]
                ...
                self.assertEqual(projected["data"]["result"]["kind"], "symbolic")
                ...
                self.assertIn(snapshot._expected_provenance_ref(module), projected["evidence_refs"])
